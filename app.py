        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .logo-mini { width: 120px; margin-bottom: 25px; mix-blend-mode: screen; opacity: 0.9; }
         .slogan {
            ...
            font-size: 0.65rem; /* Más pequeño para que parezca un sello */
        ...
        .subtitulo-app {
            ...
            font-size: 1rem; /* Un poco más pequeño que antes para elegancia */
...
<body>
    ...
    <div id="main-content">
        <header>
            ...
            <p style="font-family: Arial; font-size: 0.55rem; opacity: 0.5; letter-spacing: 2px; margin-bottom: 15px;">Versión 1.0</p>
